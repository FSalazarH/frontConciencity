	...
	render(){
		return(
			...
			<Navbar fixed={true} className="navbar-fixed-top hide-on-med-and-down wave-green" >
			 <NavItem> 
			 <img  width="200px" alt="logo-white" src= {window.location.origin + '/img/logo-white.png'}  className="responsive-img"/>  
			 ...
			 <NavItem href="#"  > 
			  	<Dropdown options={{belowOrigin: true}} trigger={
			  					<div className="bold nobreak">
						              ...
						              <img  alt="recolector" style={{'background':'#11998e'}} src= {window.location.origin + '/img/USUARIO-RECOLECTOR.png'} class="circle responsive-img"/> 
						  			</span>
